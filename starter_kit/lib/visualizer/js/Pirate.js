...
function Pirate(id, gameId, time, reasonOfDeath, treasureHistory, attackHistory, defenseHistory, drinkHistory, attackRadiusHistory, robPowerupHistory, movePowerupHistory, speedPowerupHistory) {
	this.id = id;
	this.gameId = gameId;
	...
	this.attackRadiusHistory = attackRadiusHistory;
	this.robPowerupHistory = robPowerupHistory;
	this.movePowerupHistory = movePowerupHistory;
	this.speedPowerupHistory = speedPowerupHistory;
	/** @private */
