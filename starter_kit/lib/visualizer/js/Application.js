...
Visualizer = function(container, options, w, h, configOverrides) {
	...
	try {
        ...
        */
		...
		this.imgMgr.put('ship_with_attack_powerup', '4-Ships_with_attack_powerup.png');
...
Visualizer.prototype.draw = function() {
	...
	if (hint) {
		...
		ctx.fillRect(loc.x+this.shiftedMap.padding, loc.y+this.shiftedMap.padding, w, 22);
		ctx.fillStyle = '#fff';
		ctx.fillText(hint, loc.x+this.shiftedMap.padding*2, loc.y + 10+this.shiftedMap.padding);
	}
